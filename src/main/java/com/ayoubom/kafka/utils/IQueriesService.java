...
public class IQueriesService {
  ...
  private static final Logger log = LoggerFactory.getLogger(IQueriesService.class);

  public IQueriesService(final KafkaStreams streams,
